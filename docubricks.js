...
function renderBricksTreeR(db,lev,elemTree, m){
	...
	for(var i=0;i<lev.length;i++){
		...
		//elemTree.setAttribute("id","bricks");
		//elemTree.setAttribute("class","collapsibleList");
...
function renderBricksTree(db){
	...
	//dCollapsibleLists.applyTo(document.getElementById("bricks"));
...
function addBrick(dx, thisunit){
	...
	if(toi == "undefined"){
		...
		img.setAttribute("src",'images/db-logo-small.png');
	...
	var bomdiv=document.createElement("div")
		var bomhead=document.createElement("div");
		bomhead.setAttribute("class","col12 colExample");
		bomheadp=document.createElement("p");

		bomheadh=document.createElement("h1");
		h2txt=document.createTextNode("Brick "+thisunit.name+" BOM");

		ptable=document.createElement("p");
		ptable.setAttribute("align","center");

		bomtable=document.createElement("table");
		bomttitle=document.createElement("thead");
		bomttr=document.createElement("tr")

			bomtn1=document.createElement("th");
			bbn1=document.createTextNode("#");
			bomtn1.appendChild(bbn1);
			bomttr.appendChild(bomtn1);

			bomtn2=document.createElement("th");
			bbn2=document.createTextNode("NAME");
			bomtn2.appendChild(bbn2);
			bomttr.appendChild(bomtn2);

			bomtn3=document.createElement("th");
			bbn3=document.createTextNode("DESCRIPTION");
			bomtn3.appendChild(bbn3);
			bomttr.appendChild(bomtn3);

			bomtn4=document.createElement("th");
			bbn4=document.createTextNode("QUANTITY");
			bomtn4.appendChild(bbn4);
			bomttr.appendChild(bomtn4);

			bomtn5=document.createElement("th");
			bbn5=document.createTextNode("PHYSICAL PART NAME");
			bomtn5.appendChild(bbn5);
			bomttr.appendChild(bomtn5);

			bomtn6=document.createElement("th");
			bbn6=document.createTextNode("SUPPLIER");
			bomtn6.appendChild(bbn6);
			bomttr.appendChild(bomtn6);

			bomttitle.appendChild(bomttr);
			bomtable.appendChild(bomttitle);
			ptable.appendChild(bomtable);

		bomheadh.appendChild(h2txt);
		bomheadp.appendChild(bomheadh);
		bomhead.appendChild(bomheadp);
		bomhead.appendChild(ptable);
		bomdiv.appendChild(bomhead)

	dx.appendChild(bomdiv);
	//////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////
